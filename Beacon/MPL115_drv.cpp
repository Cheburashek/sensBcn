...
#include "microhal.h"
#include "microhal_bsp.h" // FIXME : not compiling ('IODevice' does not name a type) when CEpin located in bsp
#include "nrf_delay.h"
...
bool MPL115::calibrate ( void )
{
	...
	// ---- Reading of a0:
	errBit = spiDev->readRegister ( MPL_READ_COEFF_BASE, tempBuf );     // 0x88->a0 MSB	@16bit
